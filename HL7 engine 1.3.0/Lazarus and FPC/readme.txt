...
The HL7 Engine is a set of Pascal units that provide functions for parsing and compiling HL7 messages as well as for reading and writing messages as files or streams.
